...
function App({ domElement }) {
      ...
      fetch(
        ...
        .then((data) => {
          if (data.isVerifyDocument == true) {
            ...
            setBlockchainDataNotFound("");
            setPopupLoading(false);
            setviewMessage("Not a verified match on the blockchain.");
          }
          // setblockchainProofData(data);
          // setOpen(true);
        })
  ...
  return (
    <div>
      <div
        className="healthloq-widget-svg-icon"
        onClick={handleOpen}
      ...
      {!loading ? (
        <Dialog
          ...
          className={
            blockchainProofData?.data?.Title
              ? "healthloq-widget-dialog_contact"
              ...
              >
                ...
                <div className="healthloq-widget-headerBlockchainVerifyProofBox mb20">
                  <input
                    ...
                    id="blockchain_proof"
                    onChange={(e) => {
                      setblockchainProofDocument(e.target.files[0]);
                      setviewMessage("");
                      setBlockchainDataNotFound("");
                    }}
                    style={{ display: "none" }}
                  ...
                  {blockchainProofDocument && (
                    <p className="healthloq-widget-uploadedImageName">
                      {blockchainProofDocument?.name}
                    </p>
                  )}
                </div>
            ...
            {blockchainProofData?.data?.Title ? (
              <>
                ...
                <DialogContentText
                  ...
                  className="healthloq-widget-verified-status"
                >
                  Status: Verified{" "}
                ...
                <div className="healthloq-widget-main-content-section">
                  <div className="healthloq-widget-sub-content-section">
                    ...
                    <DialogContentText id="alert-dialog-description">
                      ...
                      Organization Name:{" "}
                      {blockchainProofData?.data?.OrganizationName} <br />
                      Organization Id:{" "}
                            ...
                            <TableBody>
                              ...
                              >
                                ...
                                <TableCell component="th" scope="row">
                                  {
                                    blockchainProofData?.data
                                      ?.IntegrantTypeCurrentIntegrantId
                                  }
                                </TableCell>
                              </TableRow>
                              <TableRow
        ...
        <div className="healthloq-widget-circular-progress">
          <CircularProgress
            sx={{ color: "rgba(0,121,55,.7098039215686275)" }}
            size={100}
          />
        </div>
      )}
